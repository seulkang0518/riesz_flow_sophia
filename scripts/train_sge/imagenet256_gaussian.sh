...
export CONFIG=${CONFIG:-configs/gen/imagenet256_gaussian_mmd_schedule.yaml}
export RUN_NAME=${RUN_NAME:-imagenet256_gaussian_mmd_schedule_1node_4gpu_official30k}
