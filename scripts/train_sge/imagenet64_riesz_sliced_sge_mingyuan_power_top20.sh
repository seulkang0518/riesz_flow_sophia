...
if [[ ! -f train_power_topk_sliced.py ]]; then
  echo "Error: train_power_topk_sliced.py was not found in repository directory: $REPO_DIR" >&2
...
export CONFIG=${CONFIG:-configs/gen/imagenet64_riesz_sliced_minyuan_power_top20.yaml}
export RUN_NAME=${RUN_NAME:-imagenet64_riesz_sliced_minyuan_power_top20}
