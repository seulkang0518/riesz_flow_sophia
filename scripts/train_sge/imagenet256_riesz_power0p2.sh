...
if [[ ! -f train_power.py ]]; then
  echo "Error: train_power.py was not found in repository directory: $REPO_DIR" >&2
...
export MASTER_PORT=${MASTER_PORT:-8372}
export CONFIG=${CONFIG:-configs/gen/imagenet256_riesz_power0p2.yaml}
export RUN_NAME=${RUN_NAME:-imagenet256_riesz_power0p2_1node_4gpu_official30k}
