...
export CONFIG=${CONFIG:-configs/gen/imagenet256_riesz_power_topk_schedule_12to8.yaml}
export RUN_NAME=${RUN_NAME:-imagenet256_riesz_power_topk_schedule_12to8_1node_4gpu_official30k}
