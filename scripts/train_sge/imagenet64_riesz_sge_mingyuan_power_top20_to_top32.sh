...
if [[ ! -f train_power_topk.py ]]; then
  echo "Error: train_power_topk.py was not found in repository directory: $REPO_DIR" >&2
...
export MASTER_PORT=${MASTER_PORT:-7683}
export CONFIG=${CONFIG:-configs/gen/imagenet64_riesz_minyuan_power_top20_to_top32.yaml}
export RUN_NAME=${RUN_NAME:-imagenet64_riesz_minyuan_power_top20_to_top32}
