...
if [[ ! -f train_sinkhorn_eff.py ]]; then
  echo "Error: train_sinkhorn_eff.py was not found in repository directory: $REPO_DIR" >&2
...
export CONFIG=${CONFIG:-configs/gen/imagenet256_ot_1node_eff.yaml}
export RUN_NAME=${RUN_NAME:-imagenet256_ot_1node_eff_4gpu_official30k}
