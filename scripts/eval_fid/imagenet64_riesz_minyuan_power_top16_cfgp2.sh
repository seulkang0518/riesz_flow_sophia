...
export CONFIG=${CONFIG:-configs/gen/imagenet64_riesz_minyuan_power_top16.yaml}
export RUN_DIR=${RUN_DIR:-/SAN/intelsys/imagenet_mmd_flow/imagenet64_riesz_minyuan_power_top16}
...
for STEPNUM in 00010000 00030000 00060000; do
