...
export MASTER_PORT=${MASTER_PORT:-28811}

# ImageNet64 Riesz Minyuan run.
export CONFIG=${CONFIG:-configs/gen/imagenet64_riesz_minyuan_power0.3.yaml}
export RUN_DIR=${RUN_DIR:-/SAN/intelsys/imagenet_mmd_flow/imagenet64_riesz_minyuan_power0.3}
...
for STEPNUM in 00010000 00030000 00060000 00090000 00120000 00150000; do
