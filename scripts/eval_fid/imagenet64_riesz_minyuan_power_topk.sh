...
export MASTER_PORT=${MASTER_PORT:-28815}

# ImageNet64 Riesz Minyuan run.
export CONFIG=${CONFIG:-configs/gen/imagenet64_riesz_minyuan_power_topk.yaml}
export RUN_DIR=${RUN_DIR:-/SAN/intelsys/imagenet_mmd_flow/imagenet64_riesz_minyuan_power_topk}
...
for STEPNUM in 00030000 00060000 00090000 00120000 00150000; do
