...
export CONFIG=${CONFIG:-configs/gen/imagenet64_riesz_minyuan_power_top20_to_top32.yaml}
export RUN_DIR=${RUN_DIR:-/SAN/intelsys/imagenet_mmd_flow/imagenet64_riesz_minyuan_power_top20_to_top32}
...
for STEPNUM in 00060000 00090000 00120000; do
