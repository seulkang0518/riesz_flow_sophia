...
# Avoid CPU oversubscription during FID feature extraction.
...
export RUN_DIR=${RUN_DIR:-/SAN/intelsys/imagenet_mmd_flow/imagenet256_gaussian_mmd_schedule_1node_4gpu_official30k}
