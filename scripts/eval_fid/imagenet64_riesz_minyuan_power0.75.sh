...
export MASTER_PORT=${MASTER_PORT:-28819}

# ImageNet64 Riesz Minyuan run.
export CONFIG=${CONFIG:-configs/gen/imagenet64_riesz_minyuan_power0.75.yaml}
export RUN_DIR=${RUN_DIR:-/SAN/intelsys/imagenet_mmd_flow/imagenet64_riesz_minyuan_power0.75}
