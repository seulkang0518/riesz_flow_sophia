...
export CONFIG=${CONFIG:-configs/gen/imagenet256_riesz_power.yaml}
export RUN_DIR=${RUN_DIR:-/SAN/intelsys/imagenet_mmd_flow/imagenet256_riesz_power_1node_4gpu_official30k}
