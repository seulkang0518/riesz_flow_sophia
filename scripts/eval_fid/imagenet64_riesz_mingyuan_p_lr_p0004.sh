...
export CONFIG=${CONFIG:-configs/gen/imagenet64_riesz_minyuan_p_lr_p0004.yaml}
export RUN_DIR=${RUN_DIR:-/SAN/intelsys/imagenet_mmd_flow/imagenet64_riesz_minyuan_p_lr_p0004}
