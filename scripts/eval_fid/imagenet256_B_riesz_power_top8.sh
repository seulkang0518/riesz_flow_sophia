...
export CONFIG=${CONFIG:-configs/gen/imagenet256_B_riesz_top8.yaml}
export RUN_DIR=${RUN_DIR:-/SAN/intelsys/imagenet_mmd_flow/imagenet256_B_riesz__top8_1node_4gpu_official30k}
