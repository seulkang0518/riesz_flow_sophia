...
export CONFIG=${CONFIG:-configs/gen/imagenet64_riesz_sliced_minyuan_power_top8.yaml}
export RUN_DIR=${RUN_DIR:-/SAN/intelsys/imagenet_mmd_flow/imagenet64_riesz_sliced_minyuan_power_top8}
