...
export CONFIG=${CONFIG:-configs/gen/imagenet64_riesz_minyuan_p_lr0.0003.yaml}
export RUN_DIR=${RUN_DIR:-/SAN/intelsys/imagenet_mmd_flow/imagenet64_riesz_minyuan_p_lr0.0003}
...
for STEPNUM in 00010000 00030000 00060000 00090000 00120000; do
