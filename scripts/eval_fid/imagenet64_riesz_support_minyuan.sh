...
export MASTER_PORT=${MASTER_PORT:-28792}

# ImageNet64 Riesz Minyuan run.
export CONFIG=${CONFIG:-configs/gen/imagenet64_riesz_minyuan_support.yaml}
export RUN_DIR=${RUN_DIR:-/SAN/intelsys/imagenet_mmd_flow/imagenet64_riesz_minyuan_support}
